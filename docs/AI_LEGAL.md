# Information Concerning Legal Issues and Generative Content in Video Games
...
- Nintendo eShop: [Nintendo Developer Portal](https://developer.nintendo.com/)
- Itch.io: [Terms of Service](https://itch.io/docs/legal/terms)

## Government Regulation and Legislation
- Global Tracker: [OECD AI Policy Observatory](https://oecd.ai/en/countries-and-initiatives)
...
- China
    - Measures for Labeling of AI-Generated Synthetic Content: https://www.chinalawtranslate.com/en/ai-labeling/
- Canada
    - Artificial Intelligence and Data Act (AIDA): https://ised-isde.canada.ca/site/innovation-canada/en/artificial-intelligence/canadas-artificial-intelligence-and-data-act

## Approach to Copyright
- Overview of LLMs and Copyright: https://en.wikipedia.org/wiki/Wikipedia:Large_language_models_and_copyright
- U.S. Copyright Office: https://www.copyright.gov/ai/

## Best Practices
- Responsible User Frameworks
    - Google: https://ai.google.dev/responsible/?utm_source=ai.google&utm_medium=referral
    - Apple: https://developer.apple.com/design/human-interface-guidelines/generative-ai#Best-practices
    - OpenAI: [Usage Policies](https://openai.com/policies/usage-policies)
- Content Moderation Tools & Guides
    - Meta's Llama Guard: https://www.llama.com/docs/model-cards-and-prompt-formats/llama-guard-4/
    - Guide to Prompt Engineering/Risks: https://www.promptingguide.ai/risks
